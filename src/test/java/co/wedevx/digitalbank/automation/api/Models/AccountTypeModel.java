...
public class AccountTypeModel {
    ...
    public AccountTypeModel(int id, String code, String category, String name, double interestRate, double minDeposit, double overdraftLimit, double overdraftFee) {
        this.id = id;
        this.code = code;
